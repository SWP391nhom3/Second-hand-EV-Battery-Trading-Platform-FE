/**
 * LeadListSkeleton Component for Staff
              ...
              >
                <td className="px-4 py-4">
                  <div className="space-y-2">
                    ...
                    <div className="h-3 bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 rounded w-24 animate-pulse"></div>
                  </div>
                </td>
                <td className="px-4 py-4">
                  <div className="space-y-2">
                    <div className="h-4 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-28 animate-pulse"></div>
                    <div className="h-3 bg-gradient-to-r from-gray-100 via-gray-50 to-gray-100 rounded w-36 animate-pulse"></div>
                  </div>
                </td>
                <td className="px-4 py-4">
                ...
                <td className="px-4 py-4">
                  <div className="flex gap-2">
                    <div className="h-8 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-16 animate-pulse"></div>
                    <div className="h-8 bg-gradient-to-r from-gray-200 via-gray-100 to-gray-200 rounded w-20 animate-pulse"></div>
                  </div>
                </td>
              </tr>
            ))}
