 ...
 * Filter component cho danh sách gói tin với debounce và local state
 */
export default function PackageFilter({ filters, onFilterChange, onReset, isSearching = false }) {
    ...
    <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm transition-all duration-300 hover:shadow-md">
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="flex-1 relative">
          ...
          <Input
            type="search"
            placeholder="Tìm kiếm theo tên gói tin..."
